...
const getCompanyInitial = (company) => String(company || "Forsa").trim().charAt(0).toUpperCase();
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#fbfbfd] text-[#111113] font-['Inter',sans-serif] selection:bg-[#5B3DF5] selection:text-white">
      <SEO />
      <HomeNavbar />
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-[#ececf1] bg-[#fbfbfd]">
          ...
          <div className="relative mx-auto max-w-[1200px] px-4 pb-14 pt-10 sm:px-6 sm:pb-20 sm:pt-14 lg:px-8 lg:pb-24">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <motion.h1 initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} transition={{delay:.05}} className="mt-5 font-['Sora',sans-serif] text-4xl font-bold leading-[1.03] tracking-[-.055em] sm:text-6xl lg:text-[68px]">
              ...
              <motion.form onSubmit={handleSearch} initial={{opacity:0,y:8}} animate={{opacity:1,y:0}} transition={{delay:.15}} className="mx-auto mt-7 max-w-3xl rounded-2xl border border-[#dedee5] bg-white p-1.5 shadow-[0_16px_50px_rgba(20,16,50,.08)]">
                <div className="flex flex-col sm:flex-row sm:items-center">
                  ...
                  <button className="flex items-center justify-center gap-2 rounded-xl bg-[#5B3DF5] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#4930D4]">
              ...
              <div className="mt-3 flex flex-wrap justify-center gap-2 text-[11px]">
                ...
                {["Full-time","Internship","Freelance","Remote"].map(x=><button key={x} onClick={()=>handleQuickTag(x)} className="rounded-full border border-[#e2e1e8] bg-white px-2.5 py-1 font-medium hover:border-[#5B3DF5]/30">{x}</button>)}
              </div>
            </div>

            {/* Product preview */}
            <motion.div initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} transition={{delay:.25,duration:.55}} className="mx-auto mt-12 max-w-5xl">
              <div className="rounded-2xl border border-[#dedee5] bg-white p-2 shadow-[0_30px_80px_rgba(25,20,55,.10)]">
                ...
                : livePosts.length === 0 ? <div className="p-10 text-center text-xs text-[#777681]">New opportunities are being added. <button onClick={()=>navigate("/explore")} className="font-semibold text-[#5B3DF5]">Explore Forsa →</button></div>
