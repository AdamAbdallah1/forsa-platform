...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="mx-auto w-fit rounded-full border border-neutral-200 bg-white/80 px-3.5 py-2 text-xs font-medium text-neutral-600 shadow-[0_1px_2px_rgba(0,0,0,0.03)] backdrop-blur lg:mx-0">
      ...
      <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:justify-center lg:justify-start">
        <button
          ...
          className="group inline-flex items-center justify-center gap-2 rounded-full bg-black px-6 py-3 text-sm font-medium text-white transition hover:-translate-y-0.5 hover:bg-neutral-800"
        >
          Join Forsa
...
function Stat({ value, label }) {
  return (
    <div className="rounded-2xl border border-neutral-200 bg-white/80 p-3 shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
